      ...
      list.push(
        ...
        >
          ...
          >
            ...
            >
              <Text>
                {`${proposal.initiator.substr(0, 6)}...${proposal.initiator.substr(proposal.initiator.length - 4, proposal.initiator.length - 1)}`}
                <br />
                {`${proposal.initiator.substr(0, 6)}...${proposal.initiator.substr(proposal.initiator.length - 4, proposal.initiator.length - 1)}`}
              </Text>
            </VStack>
      ...
      <Center>
        ...
        >
          ...
          <Text
            ...
            marginBottom="18px"
          >
            Current future swaps already filled.
          </Text>
          <Table>
            <Thead>
              <Tr>
